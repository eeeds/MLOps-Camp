...
business_travel = col11.selectbox(
    'Business Travel',
    ('Travel_Frequently', 'Travel_Rarely', 'Non-Travel')
)

department = col12.selectbox(
    'Department',
...
marital_status = col23.selectbox(
    'Marital Status',
...
over_18 = col71.selectbox(
    'Over 18',
    ('Yes', 'No')
)

overtime = col72.selectbox(
    'Overtime', 
    ('Yes', 'No')
)
...
col115.write(f"""<p class="big-font">
{pred:0.2f}
</p>
""", unsafe_allow_html=True)
